...
function SetupORRUBAHistograms()
  if not orruba_applycal then
    AddMonitor("ORRUBA En vs. Ch", {name="h_ornl_envsch", title="ORNL DAQ Energy vs. Channel", xmin=0, xmax=899, nbinsx=899, ymin=0, ymax=4096, nbinsy=2048})
  else
    ...
    AddMonitor("SIDAR En vs. Strip Gate Protons + Coinc S800", {name = "sidar_en_vs_strip_protons_coinc", title = "SIDAR Energy vs. Strip# gate protons + coinc S800", xmin = 0, xmax = 16, nbinsx = 16, ymin = 0, ymax = 15, nbinsy = 1500})
